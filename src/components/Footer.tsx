...
export default function Footer() {
  ...
  return (
    <footer style={{ background: '#22280f', color: 'var(--on-olive)' }}>
      <div
        style={{
          maxWidth: 1220,
          margin: '0 auto',
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 14.5, lineHeight: 1.6, color: 'rgba(239,237,221,.66)', marginTop: 18, maxWidth: '34ch' }}>
            Adult internal medicine & primary care in Jamaica, Queens. Unhurried visits, same-week appointments, one team
            that knows you.
          </p>
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8, marginTop: 18, fontFamily: "'DM Mono',monospace", fontSize: 12.5, color: 'rgba(239,237,221,.8)' }}>
          ...
          <nav style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {LINKS.map((l) => (
              <button
                ...
                style={{ textAlign: 'left', fontSize: 15, color: 'rgba(239,237,221,.82)' }}
              >
                {l.label}
              </button>
            ))}
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <a href={clinic.phoneHref} style={{ display: 'inline-flex', alignItems: 'center', gap: 10, fontSize: 15, color: 'rgba(239,237,221,.9)', textDecoration: 'none' }}>
            ...
            <a
              ...
              style={{ display: 'inline-flex', alignItems: 'flex-start', gap: 10, fontSize: 15, lineHeight: 1.5, color: 'rgba(239,237,221,.9)', textDecoration: 'none', maxWidth: '28ch' }}
            >
      ...
      <div style={{ borderTop: '1px solid rgba(239,237,221,.14)' }}>
        <div
          style={{
            maxWidth: 1220,
            margin: '0 auto',
